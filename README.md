...
* **MyTraL** (Python)
    * My training and personal log, which I use to synchronize, aggregate, digitize, normalize, analyze, and predict the sports activities I have done since 1996.

I like to read math books (really bad at it) and the source code of interesting projects before going to sleep - especially [VMs](https://github.com/dvorka/logr-jvm-gc), compilers, and machine learning models.
