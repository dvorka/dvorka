...
I use my **[open-source projects](https://projects.mindforger.com/)** on a daily basis:
...
* **[MyTraL](https://github.com/dvorka/mytral)** (Python, Flask/Tabler)
    * A personal training log where I gather, digitize, analyze, and predict my activities - 30+ years and 3GB+ of data.
* **[Coaching Notebook](https://github.com/dvorka/coaching-notebook)** (Java, Google App Engine, BigTable, GWT)
    - Auto coach which helped me to systematically plan, solve problems, learn from mistakes, and brainstorm using SWOT, SMARTER goals, and Eisenhower matrix.
<!--
